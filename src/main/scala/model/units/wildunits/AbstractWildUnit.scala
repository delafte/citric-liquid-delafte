 ...
 */
abstract class AbstractWildUnit(protected val _maxHP: Int,protected val _ATK: Int, protected val _DEF: Int, protected val _EVA: Int, protected val _BonusStars: Int) extends AbstractUnity with WildUnit{
